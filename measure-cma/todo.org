* TODO bug: when guide line is completely vertical, perp lines are wrong
* TODO bug: undoing state to initial results in weird white spots
* TODO fix filename of download
